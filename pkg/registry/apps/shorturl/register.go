...
func RegisterAppInstaller(
	...
	// Pass AppURL configuration to the app
	appSpecificConfig := &shorturlapp.ShortURLConfig{
		AppURL: cfg.AppURL,
	}
	provider := simple.NewAppProvider(apis.LocalManifest(), appSpecificConfig, shorturlapp.New)
